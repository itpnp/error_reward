          ...
          <div class="x_content">
            <br />
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="namaKaryawan" value="<?php if($dataKaryawan != null) echo $dataKaryawan->employeeName;?>" name="namaKaryawan" type="text" required readonly/>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Jumlah Tilang Bulan Ini </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="jumlahTilang" value="<?php if($jumlahTilang != null) echo $jumlahTilang ;?>" name="jumlahTilang" type="text" required readonly/>
                </div>
              </div>
