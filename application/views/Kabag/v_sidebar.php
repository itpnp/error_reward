      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
             <form class="form-horizontal form-label-left" novalidate id="demo-form2" role="form" method="post" action="<?php echo base_url()?>index.php/kabag/updateProfileApp" data-parsley-validate class="form-horizontal form-label-left">
