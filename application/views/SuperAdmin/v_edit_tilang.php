    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
              <input type="hidden" name='idTilang' value="<?php if($dataTilang != null) echo $dataTilang->ticketId ;?>"/>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">NIK</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="nik" value="<?php if($dataTilang != null) echo $dataTilang->subject->nik ;?>" name = "nik" type="text" required readonly/>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Karyawan</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="namaKaryawan" value="<?php if($dataTilang != null) echo $dataTilang->subject->employeeName;?>" name="namaKaryawan" type="text" required readonly/>
                </div>
              </div>
              <!-- <div class="form-group">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="date" value="<?php if($dataTilang != null) echo $dataTilang->ticketDate ;?>" name="tanggalTilang" type="text" required/>
                </div>
              </div>
              <div class="form-group">
                ...
                <select class="form-control" name="chooseCategory" id="chooseCategory" onChange="showSubCategory()">
                  ...
                  foreach($dataKategori as $row){
                    if ($dataTilang->subCategoryTicket->ticketCategory->categoryName === $row->categoryName) {
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="chooseSubCategory" id="chooseSubCategory" required>
                  ...
                  foreach($dataSubCategory as $row1){
                    if ($dataTilang->subCategoryTicket->subCategoryName === $row1->subCategoryName) {
                      echo '<option value="'.$row1->subCategoryId.'" selected>'.$row1->subCategoryName.'</option>';
                    }else{
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="nominalTilang" value="<?php if($dataTilang != null) echo $dataTilang->fine ;?>" name = "nominalTilang" type="text" required readonly/>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">KETERANGAN</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control" id="keterangan" value="<?php if($dataTilang != null) echo $dataTilang->additionalInfo ;?>" name = "keterangan" type="text" required />
                </div>
              </div>
