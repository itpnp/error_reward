                        ...
                        <tbody>
                          <?php
                              ...
                              foreach($dataTilang as $row)
                                {
                                  echo "<tr>
                                    <td class='warning'>".$row->subject->nik."</td>
                                    <td class='warning'>".$row->subject->employeeName."</td>
                                    <td class='warning'>".date('d M Y',strtotime($row->ticketDate))."</td>
                                    <td class='warning'>".$row->subCategoryTicket->ticketCategory->categoryName."</td>
                                    <td class='warning'><a href = 'editTilang/".$row->ticketId."'>EDIT</a></td>
                                    </tr>"
                                  ;
                                }
                            ?>
